...
def get_axialunet_model():
    model = axialunet(img_size = 512, imgchan = 3)
    return model
def get_MedT_model():
    model = MedT(img_size = 512, imgchan = 3)
    return model
def get_gated_model():
    model = gated(img_size = 512, imgchan = 3)
    return model
def get_logo_model():
    model = logo(img_size = 512, imgchan = 3)
    return model
...
def test():
    ...
    model = get_MedT_model().to(device)
    res1 = model(inputs)
    ...
    # print('MedT flops:', macs)
    # print('MedT params:', params)
